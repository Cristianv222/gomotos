...
urlpatterns = [
    ...
    path('pedidos-online/<int:pedido_id>/confirmar/', views.confirmar_pedido_online, name='confirmar_pedido_online'),
    path('pedidos-online/<int:pedido_id>/despachar/', views.despachar_pedido_online, name='despachar_pedido_online'),
    path('pedidos-online/<int:pedido_id>/entregar/', views.entregar_pedido_online, name='entregar_pedido_online'),
    path('pedidos-online/<int:pedido_id>/cancelar/', views.cancelar_pedido_online, name='cancelar_pedido_online'),
    path('pedidos-online/<int:pedido_id>/procesar-venta/', views.procesar_venta_desde_pedido, name='procesar_venta_desde_pedido'),

    # ========== PEDIDOS ONLINE — API PÚBLICA (PHP ecommerce) ==========
    path('api/publica/pedidos/crear/', views.api_crear_pedido_online, name='api_crear_pedido_online'),
    path('api/publica/pedidos/<str:numero_orden>/estado/', views.api_estado_pedido, name='api_estado_pedido'),
    path('pedidos/<int:pedido_id>/verificar-pago/', views.marcar_pago_verificado, name='marcar_pago_verificado'),
